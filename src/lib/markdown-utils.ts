...
const stripMarkdownPlugin = stripMarkdown as Plugin<[(Readonly<StripMarkdownOptions> | null | undefined)?], Root, Root>;
...
export function cleanMarkdown(content: string): string {
    ...
    try {
        ...
        const file = remark().use(stripMarkdownPlugin).processSync(text);
        text = String(file);
